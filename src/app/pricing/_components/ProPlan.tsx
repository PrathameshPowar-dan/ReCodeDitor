import { ArrowRight, Beer, Command } from "lucide-react";
import Link from "next/link";

function ProPlanView() {
  return (
    <div className=" bg-[#0a0a0f]/10">
      <div className="relative px-4 h-[80vh] flex items-center justify-center">
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/30 to-blue-500/30 blur-2xl opacity-10" />

          <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/[0.05] to-blue-500/[0.05] rounded-2xl" />

            <div className="relative">
              <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-500/10 mb-6 ring-1 ring-gray-800/60">
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-blue-500/10 to-blue-500/10 hover:from-blue-500/20 hover:to-blue-500/20 text-white rounded-xl transition-all duration-200 border border-gray-800 hover:border-blue-500/50 group"
              >
