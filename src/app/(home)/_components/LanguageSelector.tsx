...
import { ChevronDownIcon, Lock, Palette, Sparkles } from "lucide-react";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-gray-200 min-w-[80px] hidden md:block text-left group-hover:text-white transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-[-80%] mt-2 w-64 bg-[#1e1e2e]/95
        ...
        hover:[&::-webkit-scrollbar-thumb]:bg-gray-600/60
        ...
        scrollbar-width: thin">
              ...
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                ...
                return (
                  ...
                  ${isLocked ? "opacity-70" : "hover:bg-[#262637]"}
                `}
